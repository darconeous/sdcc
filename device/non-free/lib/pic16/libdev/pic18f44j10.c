...
__sfr __at (0xF85) SSP2CON2;
volatile __SSP2CON2bits_t __at (0xF85) SSP2CON2bits;

__sfr __at (0xF86) SSP2CON1;
volatile __SSP2CON1bits_t __at (0xF86) SSP2CON1bits;

__sfr __at (0xF87) SSP2STAT;
volatile __SSP2STATbits_t __at (0xF87) SSP2STATbits;

__sfr __at (0xF88) SSP2ADD;
