/*
 * pic18f4580.h - device specific declarations
 *
...
#ifndef __PIC18F4580_H__
#define __PIC18F4580_H__ 1
...
#define	_BBSIZ_1024_4L      	0xEF	 // 1K words (2K bytes) Boot Block
#define	_BBSIZ_2048_4L      	0xFF	 // 2K words (4K bytes) Boot Block
