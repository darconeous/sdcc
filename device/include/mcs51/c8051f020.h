...
sfr at 0x98 SCON     ;  /* UART0 CONTROL                                           */
sfr at 0x98 SCON0    ;  /* UART0 CONTROL                                           */
sfr at 0x99 SBUF     ;  /* UART0 BUFFER                                            */
sfr at 0x99 SBUF0    ;  /* UART0 BUFFER                                            */
...
sfr at 0xA1 EMI0TC   ;  /* External Memory Timing Control                          */
...
sfr at 0xA9 SADDR0   ;  /* UART0 Slave Address                                     */
sfr at 0xAA ADC1CN   ;  /* ADC 1 CONTROL                                           */
sfr at 0xAB ADC1CF   ;  /* ADC 1 CONFIGURATION                                     */
sfr at 0xAC AMX1SL   ;  /* ADC 1 MUX CHANNEL SELECTION                             */
sfr at 0xAD P3IF     ;  /* PORT 3 EXTERNAL INTERRUPT FLAGS                         */
sfr at 0xAE SADEN1   ;  /* UART1 Slave Address Enable                              */
...
sfr at 0xF1 SCON1    ;  /* UART1 CONTROL                                           */
sfr at 0xF2 SBUF1    ;  /* UART1 DATA                                              */
sfr at 0xF3 SADDR1   ;  /* UART1 Slave Address                                     */
...
sbit at 0x9D SM20    ;  /* SCON.5 - MULTIPROCESSOR COMMUNICATION ENABLE */
sbit at 0x9D MCE0    ;  /* SCON.5 - MULTIPROCESSOR COMMUNICATION ENABLE */
sbit at 0x9E SM1     ;  /* SCON.6 - SERIAL MODE CONTROL BIT 1           */
sbit at 0x9E SM10    ;  /* SCON.6 - SERIAL MODE CONTROL BIT 1           */
sbit at 0x9F SM0     ;  /* SCON.7 - SERIAL MODE CONTROL BIT 0           */
sbit at 0x9F SM00    ;  /* SCON.7 - SERIAL MODE CONTROL BIT 0           */
...
sbit at 0xAC ES      ;  /* SERIAL PORT 0 INTERRUPT ENABLE            */
sbit at 0xAC ES0     ;  /* SERIAL PORT 0 INTERRUPT ENABLE            */
...
sbit at 0xE9 ADWINT  ;  /* ADC 0 WINDOW COMPARE INTERRUPT FLAG       */
...
sbit at 0xEC ADBUSY  ;  /* ADC 0 BUSY FLAG                           */
sbit at 0xEC AD0BUSY ;  /* ADC 0 BUSY FLAG                           */
sbit at 0xED ADCINT  ;  /* ADC 0 CONVERISION COMPLETE INTERRUPT FLAG */
sbit at 0xED AD0INT  ;  /* ADC 0 CONVERISION COMPLETE INTERRUPT FLAG */
sbit at 0xEE ADCTM   ;  /* ADC 0 TRACK MODE                          */
sbit at 0xEE AD0TM   ;  /* ADC 0 TRACK MODE                          */
sbit at 0xEF ADCEN   ;  /* ADC 0 ENABLE                              */
