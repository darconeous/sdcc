//
// Register Declarations for Microchip 16F914 Processor
//
//
...
// information for the PIC16F914 microcontroller.
...
typedef union {
  ...
  struct {
    unsigned char S16C3:1;
    unsigned char S17C3:1;
    unsigned char S18C3:1;
    unsigned char S19C3:1;
    unsigned char S20C3:1;
    unsigned char S21C3:1;
    unsigned char S22C3:1;
    unsigned char S23C3:1;
  };
} __LCDDATA11_bits_t;
...
#define S17C3                LCDDATA11_bits.S17C3
#define SEG18COM3            LCDDATA11_bits.SEG18COM3
#define S18C3                LCDDATA11_bits.S18C3
#define SEG19COM3            LCDDATA11_bits.SEG19COM3
#define S19C3                LCDDATA11_bits.S19C3
#define SEG20COM3            LCDDATA11_bits.SEG20COM3
#define S20C3                LCDDATA11_bits.S20C3
#define SEG21COM3            LCDDATA11_bits.SEG21COM3
#define S21C3                LCDDATA11_bits.S21C3
#define SEG22COM3            LCDDATA11_bits.SEG22COM3
...
typedef union {
  ...
  struct {
    unsigned char S16C0:1;
    unsigned char S17C0:1;
    unsigned char S18C0:1;
    unsigned char S19C0:1;
    unsigned char S20C0:1;
    unsigned char S21C0:1;
    unsigned char S22C0:1;
    unsigned char S23C0:1;
  };
} __LCDDATA2_bits_t;
...
#define S17C0                LCDDATA2_bits.S17C0
#define SEG18COM0            LCDDATA2_bits.SEG18COM0
#define S18C0                LCDDATA2_bits.S18C0
#define SEG19COM0            LCDDATA2_bits.SEG19COM0
#define S19C0                LCDDATA2_bits.S19C0
#define SEG20COM0            LCDDATA2_bits.SEG20COM0
#define S20C0                LCDDATA2_bits.S20C0
#define SEG21COM0            LCDDATA2_bits.SEG21COM0
#define S21C0                LCDDATA2_bits.S21C0
#define SEG22COM0            LCDDATA2_bits.SEG22COM0
...
typedef union {
  ...
  struct {
    unsigned char S16C1:1;
    unsigned char S17C1:1;
    unsigned char S18C1:1;
    unsigned char S19C1:1;
    unsigned char S20C1:1;
    unsigned char S21C1:1;
    unsigned char S22C1:1;
    unsigned char S23C1:1;
  };
} __LCDDATA5_bits_t;
...
#define S17C1                LCDDATA5_bits.S17C1
#define SEG18COM1            LCDDATA5_bits.SEG18COM1
#define S18C1                LCDDATA5_bits.S18C1
#define SEG19COM1            LCDDATA5_bits.SEG19COM1
#define S19C1                LCDDATA5_bits.S19C1
#define SEG20COM1            LCDDATA5_bits.SEG20COM1
#define S20C1                LCDDATA5_bits.S20C1
#define SEG21COM1            LCDDATA5_bits.SEG21COM1
#define S21C1                LCDDATA5_bits.S21C1
