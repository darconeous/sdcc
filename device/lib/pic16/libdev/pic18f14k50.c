/*
 * pic18f14k50.c - device specific definitions
 *
...
__sfr __at (0xF53) UEP0;
volatile __UEP0bits_t __at (0xF53) UEP0bits;

__sfr __at (0xF54) UEP1;
volatile __UEP1bits_t __at (0xF54) UEP1bits;

__sfr __at (0xF55) UEP2;
volatile __UEP2bits_t __at (0xF55) UEP2bits;

__sfr __at (0xF56) UEP3;
volatile __UEP3bits_t __at (0xF56) UEP3bits;

__sfr __at (0xF57) UEP4;
volatile __UEP4bits_t __at (0xF57) UEP4bits;

__sfr __at (0xF58) UEP5;
volatile __UEP5bits_t __at (0xF58) UEP5bits;

__sfr __at (0xF59) UEP6;
volatile __UEP6bits_t __at (0xF59) UEP6bits;

__sfr __at (0xF5A) UEP7;
volatile __UEP7bits_t __at (0xF5A) UEP7bits;

__sfr __at (0xF5B) UEIE;
volatile __UEIEbits_t __at (0xF5B) UEIEbits;

__sfr __at (0xF5C) UADDR;
volatile __UADDRbits_t __at (0xF5C) UADDRbits;

__sfr __at (0xF5D) UFRML;
volatile __UFRMLbits_t __at (0xF5D) UFRMLbits;

__sfr __at (0xF5E) UFRMH;
volatile __UFRMHbits_t __at (0xF5E) UFRMHbits;

__sfr __at (0xF5F) UEIR;
volatile __UEIRbits_t __at (0xF5F) UEIRbits;

__sfr __at (0xF60) UIE;
volatile __UIEbits_t __at (0xF60) UIEbits;

__sfr __at (0xF61) UCFG;
volatile __UCFGbits_t __at (0xF61) UCFGbits;

__sfr __at (0xF62) UIR;
volatile __UIRbits_t __at (0xF62) UIRbits;

__sfr __at (0xF63) USTAT;
volatile __USTATbits_t __at (0xF63) USTATbits;

__sfr __at (0xF64) UCON;
volatile __UCONbits_t __at (0xF64) UCONbits;

__sfr __at (0xF68) SRCON0;
volatile __SRCON0bits_t __at (0xF68) SRCON0bits;

__sfr __at (0xF69) SRCON1;
volatile __SRCON1bits_t __at (0xF69) SRCON1bits;

__sfr __at (0xF6B) CM2CON0;
volatile __CM2CON0bits_t __at (0xF6B) CM2CON0bits;

__sfr __at (0xF6C) CM2CON1;
volatile __CM2CON1bits_t __at (0xF6C) CM2CON1bits;

__sfr __at (0xF6D) CM1CON0;
volatile __CM1CON0bits_t __at (0xF6D) CM1CON0bits;

__sfr __at (0xF6F) SSPMSK;
volatile __SSPMSKbits_t __at (0xF6F) SSPMSKbits;

__sfr __at (0xF76) SLRCON;
volatile __SLRCONbits_t __at (0xF76) SLRCONbits;

__sfr __at (0xF77) WPUA;
volatile __WPUAbits_t __at (0xF77) WPUAbits;

__sfr __at (0xF78) WPUB;
volatile __WPUBbits_t __at (0xF78) WPUBbits;

__sfr __at (0xF79) IOCA;
volatile __IOCAbits_t __at (0xF79) IOCAbits;

__sfr __at (0xF7A) IOCB;
volatile __IOCBbits_t __at (0xF7A) IOCBbits;
...
volatile __EEADRHbits_t __at (0xFAA) EEADRHbits;
...
__sfr __at (0xFBA) REFCON0;
volatile __REFCON0bits_t __at (0xFBA) REFCON0bits;

__sfr __at (0xFBA) VREFCON0;
volatile __VREFCON0bits_t __at (0xFBA) VREFCON0bits;

__sfr __at (0xFBB) REFCON1;
volatile __REFCON1bits_t __at (0xFBB) REFCON1bits;

__sfr __at (0xFBB) VREFCON1;
volatile __VREFCON1bits_t __at (0xFBB) VREFCON1bits;

__sfr __at (0xFBC) REFCON2;
volatile __REFCON2bits_t __at (0xFBC) REFCON2bits;

__sfr __at (0xFBC) VREFCON2;
volatile __VREFCON2bits_t __at (0xFBC) VREFCON2bits;
