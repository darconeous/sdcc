...
00121$:
	...
	mov	b,#0x00
	add	a,#0x6a
	mov	___fs2ulong_exp_1_1,a
	mov	a,b
	addc	a,#0xff
	mov	(___fs2ulong_exp_1_1 + 1),a
;	_fs2ulong.c 85
...
00124$:
	...
	orl	a,(___fs2ulong_l_1_1 + 1)
	orl	a,(___fs2ulong_l_1_1 + 2)
	orl	a,(___fs2ulong_l_1_1 + 3)
...
00128$:
	clr	c
	clr	a
	subb	a,___fs2ulong_l_1_1
	mov	r2,a
	clr	a
	subb	a,(___fs2ulong_l_1_1 + 1)
	mov	r3,a
	clr	a
	subb	a,(___fs2ulong_l_1_1 + 2)
	mov	r6,a
	clr	a
	subb	a,(___fs2ulong_l_1_1 + 3)
	mov	r7,a
; Peephole 132   changed ljmp to sjmp
	sjmp 00113$
00112$:
	...
	mov	r6,(___fs2ulong_l_1_1 + 2)
	mov	r7,(___fs2ulong_l_1_1 + 3)
00113$:
	mov	dpl,r2
	mov	dph,r3
	mov	b,r6
