...
00107$:
	...
	mov	(__modslong_sloc0_1_0 + 1),r7
	mov	(__modslong_sloc0_1_0 + 2),r0
	mov	(__modslong_sloc0_1_0 + 3),r1
;	_modslong.c 29
...
00109$:
	...
	movx	@dptr,a
	push	ar2
	mov	dpl,__modslong_sloc0_1_0
	mov	dph,(__modslong_sloc0_1_0 + 1)
	mov	b,(__modslong_sloc0_1_0 + 2)
...
; Peephole 191   removed redundant mov
	...
	mov  dph,(__modslong_sloc1_1_0 + 1)
	mov  b,(__modslong_sloc1_1_0 + 2)
; Peephole 132   changed ljmp to sjmp
	sjmp 00104$
00102$:
;	_modslong.c 34
