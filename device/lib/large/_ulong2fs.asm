...
00113$:
	...
	mov	___ulong2fs_sloc0_1_0,#0x96
00105$:
	mov	dptr,#___ulong2fs_a1_1_1
	movx	a,@dptr
	mov	r4,a
...
;	_ulong2fs.c 102
	...
	mov	a,#0xff
	cjne	a,___ulong2fs_sloc0_1_0,00117$
...
;	_ulong2fs.c 105
	anl	ar6,#0x7f
;	_ulong2fs.c 107
	mov	r2,___ulong2fs_sloc0_1_0
	mov	r3,(___ulong2fs_sloc0_1_0 + 1)
	mov	r0,#0x00
	mov	r1,#0x00
	mov	(___ulong2fs_sloc1_1_0 + 2),r2
	mov	a,r3
	anl	a,#0x01
	mov	c,acc.0
	xch	a,(___ulong2fs_sloc1_1_0 + 2)
	rrc	a
	xch	a,(___ulong2fs_sloc1_1_0 + 2)
	rrc	a
	xch	a,(___ulong2fs_sloc1_1_0 + 2)
	mov	(___ulong2fs_sloc1_1_0 + 3),a
	mov	(___ulong2fs_sloc1_1_0 + 1),#0x00
	mov	___ulong2fs_sloc1_1_0,#0x00
	mov	dptr,#___ulong2fs_sign_1_1
	movx	a,@dptr
	mov	r2,a
	inc	dptr
