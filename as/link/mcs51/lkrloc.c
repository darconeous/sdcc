...
VOID relr(VOID)
{
    ...
    a_uint r, rtbase, rtofst, paga, pags, pc;
    struct areax **a;
    struct sym **s;
...
a_uint adb_b(register a_uint v, register int i)
{
    return(rtval[i] += v);
}
...
a_uint adb_bit(register a_uint v, register int i)
{
    register a_uint j;
...
a_uint adb_24_bit(register a_uint v, register int i)
{
    register a_uint j;
...
a_uint adb_24_hi(a_uint v, int i)
{
    register a_uint j;
...
a_uint adb_24_mid(a_uint v, int i)
{
    register a_uint j;
...
a_uint adb_24_lo(a_uint v, int i)
{
    register a_uint j;
...
a_uint adw_w(register a_uint v, register int i)
{
    register a_uint j;
